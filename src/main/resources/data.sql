...
INSERT INTO COMMENT(BOARD_ID, MEMBER_ID, CONTENT, ISUPDATED, DATE)
VALUES (3, 1, '인정 인정', false, CURRENT_TIME());

INSERT INTO COMMENT(BOARD_ID, MEMBER_ID, CONTENT, ISUPDATED, DATE)
VALUES (3, 2, '노잼',  false, CURRENT_TIME());

INSERT INTO COMMENT(BOARD_ID, MEMBER_ID, CONTENT, ISUPDATED, DATE)
VALUES (2, 3, '아근데 그런경우가 좀 있어', false, CURRENT_TIME());

INSERT INTO COMMENT(BOARD_ID, MEMBER_ID, CONTENT, ISUPDATED, DATE)
VALUES (1, 4, '여긴 왜 댓글이 없냐', false, CURRENT_TIME());

INSERT INTO COMMENT(BOARD_ID, MEMBER_ID, CONTENT, ISUPDATED, DATE)
VALUES (4, 5, 'ㅋㅋㅋㅋ', false, CURRENT_TIME());

INSERT INTO COMMENT(BOARD_ID, MEMBER_ID, CONTENT, ISUPDATED, DATE)
VALUES (5, 1, '오우', false, CURRENT_TIME());

INSERT INTO COMMENT(BOARD_ID, MEMBER_ID, CONTENT, ISUPDATED, DATE)
VALUES (5, 2, 'ㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋ', false, CURRENT_TIME());
